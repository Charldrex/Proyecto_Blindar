            ...
            child: Column(
              children: [
                CheckboxListTile(
                  ...
                  title: const Text("BOTÓN CROMADO CON WASA Y TORNILLO"),
          ...
          Card(
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title: const Text("C-4110 CON SUS 3 TORNILLOS"),
                  checkColor: Colors.white,
                  value: isChecked2,
                  onChanged: (bool? value) {
                    setState(() {
          ...
          Card(
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title: const Text("SISTEMA ANTI PALANCA EN EL MONEDERO"),
                  checkColor: Colors.white,
                  value: isChecked4,
                  onChanged: (bool? value) {
                    setState(() {
            ...
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title: const Text(
                      "BANDEJA DEL COMPARTIMIENTO INTERNO CON SUS 4 UÑAS"),
                  checkColor: Colors.white,
                  value: isChecked5,
                  onChanged: (bool? value) {
                    setState(() {
            ...
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title: const Text(
                      "SISTEMA DE RETRABES BIEN ENSAMBLADOS (CÁÑAMO, TORNILLOS BSC RESORTES Y TRABA ROSCAS)"),
                  checkColor: Colors.white,
                  value: isChecked7,
                  onChanged: (bool? value) {
                    setState(() {
          ...
          Card(
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title: const Text("EL MECANISMO ESTÁ SUAVE"),
                  checkColor: Colors.white,
                  value: isChecked8,
                  onChanged: (bool? value) {
                    setState(() {
          ...
          Card(
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title: const Text("FUNCIONAMIENTO C-6730 ENTIDAD BB"),
                  checkColor: Colors.white,
                  value: isChecked13,
                  onChanged: (bool? value) {
                    setState(() {
          ...
          Card(
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title: const Text("LLAVE CAMBIO DE CLAVE C-6730 ENTIDAD BB"),
                  checkColor: Colors.white,
                  value: isChecked15,
                  onChanged: (bool? value) {
                    setState(() {
            ...
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title:
                      const Text("FUNCIONAMIENTO TECLADO KP ENTIDAD CREZCAMOS"),
                  checkColor: Colors.white,
                  value: isChecked17,
                  onChanged: (bool? value) {
                    setState(() {
          ...
          Card(
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title: const Text("PILAS 9 VOLTIOS ENTIDAD CREZCAMOS"),
                  checkColor: Colors.white,
                  value: isChecked18,
                  onChanged: (bool? value) {
                    setState(() {
          ...
          Card(
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title: const Text("TERMOSTATO ENTIDAD CREZCAMOS"),
                  checkColor: Colors.white,
                  value: isChecked19,
                  onChanged: (bool? value) {
                    setState(() {
          ...
          Card(
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title: const Text("MAGNÉTICO ENTIDAD CREZCAMOS"),
                  checkColor: Colors.white,
                  value: isChecked20,
                  onChanged: (bool? value) {
                    setState(() {
