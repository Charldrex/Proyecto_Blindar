                              ...
                              children: [
                                SizedBox(
                                  ...
                                  child: CheckboxListTile(
                                    controlAffinity:
                                        ListTileControlAffinity.leading,
                                    title: const Text("RESORTE EN EXCÉNTRICA CON SUS BUJES, WASA Y TORNILLOS BCC"),
                                    checkColor: Colors.white,
                                    value: isChecked3,
                                    onChanged: (bool? value) {
                                      setState(() {
                                ...
                                SizedBox(
                                  ...
                                  child: CheckboxListTile(
                                    controlAffinity:
                                        ListTileControlAffinity.leading,
                                    title: const Text(
                                        "REGLETA DE 6 TORNILLOS CON NUMERACIÓN (2)"),
                                    checkColor: Colors.white,
                                    value: isChecked17,
                                    onChanged: (bool? value) {
                                      setState(() {
