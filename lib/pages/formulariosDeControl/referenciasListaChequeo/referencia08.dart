          ...
          Card(
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title: const Text("FUNCIONAMIENTO DE CERRADURA 4110"),
                  checkColor: Colors.white,
                  value: isChecked2,
                  onChanged: (bool? value) {
                    setState(() {
          ...
          Card(
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title: const Text("PIN CHAVETA ABIERTOS (2)"),
                  checkColor: Colors.white,
                  value: isChecked5,
                  onChanged: (bool? value) {
                    setState(() {
          ...
          Card(
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title: const Text("GAVETA CON SUS 4 TORNILLOS Y REED SWICHT"),
                  checkColor: Colors.white,
                  value: isChecked6,
                  onChanged: (bool? value) {
                    setState(() {
            ...
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title:
                      const Text("MARCO BUZÓN CON SUS RESPECTIVOS TORNILLOS"),
                  checkColor: Colors.white,
                  value: isChecked7,
                  onChanged: (bool? value) {
                    setState(() {
          ...
          Card(
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title: const Text("FUNCIONAMIENTO TECLADO KP"),
                  checkColor: Colors.white,
                  value: isChecked8,
                  onChanged: (bool? value) {
                    setState(() {
          ...
          Card(
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title: const Text("PILAS 9 VOLTIOS"),
                  checkColor: Colors.white,
                  value: isChecked9,
                  onChanged: (bool? value) {
                    setState(() {
            ...
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title:
                      const Text("REGLETA DE 10 TORNILLOS CON NUMERACIÓN (2)"),
                  checkColor: Colors.white,
                  value: isChecked12,
                  onChanged: (bool? value) {
                    setState(() {
          ...
          Card(
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title: const Text("7 POSITIVO- 8 NEGATIVO (9 VOLTIOS)"),
                  checkColor: Colors.white,
                  value: isChecked16,
                  onChanged: (bool? value) {
                    setState(() {
          ...
          Card(
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title: const Text("PINTURA Y LIMPIEZA GENERAL"),
                  checkColor: Colors.white,
                  value: isChecked23,
                  onChanged: (bool? value) {
                    setState(() {
