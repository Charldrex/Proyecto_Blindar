            ...
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title: const Text(
                      "BRAZOS DE LA TÓMBOLA BIEN AJUSTADOS CON SUS TORNILLOS Y TUERCA SEGURIDAD"),
                  checkColor: Colors.white,
                  value: isChecked3,
                  onChanged: (bool? value) {
                    setState(() {
            ...
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title:
                      const Text("MANIJA APERTURA DE TÓMBOLA BIEN ASEGURADA"),
                  checkColor: Colors.white,
                  value: isChecked4,
                  onChanged: (bool? value) {
                    setState(() {
          ...
          Card(
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title: const Text("MÓDULO DE ALARMA"),
                  checkColor: Colors.white,
                  value: isChecked12,
                  onChanged: (bool? value) {
                    setState(() {
          ...
          Card(
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title: const Text("FUNCIONAMIENTO CERRADURA 6125 CON BP"),
                  checkColor: Colors.white,
                  value: isChecked13,
                  onChanged: (bool? value) {
                    setState(() {
          ...
          Card(
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title: const Text("4 PATAS O TOPES DE CAUCHO"),
                  checkColor: Colors.white,
                  value: isChecked17,
                  onChanged: (bool? value) {
                    setState(() {
