          ...
          Card(
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title: const Text("AJUSTE SUAVE DE LA PUERTA"),
                  checkColor: Colors.white,
                  value: isChecked2,
                  onChanged: (bool? value) {
                    setState(() {
            ...
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title: const Text(
                      "REFUERZO DE LA PARTE INTERIOR, PARTE SUPERIOR E INFERIOR"),
                  checkColor: Colors.white,
                  value: isChecked3,
                  onChanged: (bool? value) {
                    setState(() {
            ...
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title:
                      const Text("VERIFICACIÓN DE LOS ÁNGULOS CON LA ESCUADRA"),
                  checkColor: Colors.white,
                  value: isChecked4,
                  onChanged: (bool? value) {
                    setState(() {
          ...
          Card(
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title: const Text("TERMINACIÓN GENERAL DE LA SOLDADURA"),
                  checkColor: Colors.white,
                  value: isChecked5,
                  onChanged: (bool? value) {
                    setState(() {
            ...
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title:
                      const Text("DESMONTAR CAJÓN PARA VERIFICAR LOS RIELES"),
                  checkColor: Colors.white,
                  value: isChecked6,
                  onChanged: (bool? value) {
                    setState(() {
          ...
          Card(
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title: const Text("VERIFICACIÓN DE LOS DUCTOS DE LOS CABLES"),
                  checkColor: Colors.white,
                  value: isChecked7,
                  onChanged: (bool? value) {
                    setState(() {
          ...
          Card(
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title: const Text("DESMONTAR LOS RIELES PARA PINTURA"),
                  checkColor: Colors.white,
                  value: isChecked8,
                  onChanged: (bool? value) {
                    setState(() {
          ...
          Column(
            children: [
              SizedBox(
                  child: ListTile(
                tileColor: Colors.indigo.shade200,
                title: const Text('CABLEADO ANTIPESCA'),
              )),
            ],
          ),
          Card(
          ...
          Card(
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title: const Text("VERIFICAR TERMINALES DE LAS BATERÍAS"),
                  checkColor: Colors.white,
                  value: isChecked11,
                  onChanged: (bool? value) {
                    setState(() {
          ...
          Card(
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title: const Text("VERIFICACIÓN DE LOS MICROS DE SABOTAJE"),
                  checkColor: Colors.white,
                  value: isChecked15,
                  onChanged: (bool? value) {
                    setState(() {
          ...
          Card(
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title: const Text("DESMONTAR CERRADURA Y TECLADO DE PRUEBAS"),
                  checkColor: Colors.white,
                  value: isChecked19,
                  onChanged: (bool? value) {
                    setState(() {
          ...
          Card(
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title: const Text("ENSAMBLE DEL ACERO"),
                  checkColor: Colors.white,
                  value: isChecked21,
                  onChanged: (bool? value) {
                    setState(() {
          ...
          Card(
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title: const Text("TOPES O PATAS DE CAUCHO"),
                  checkColor: Colors.white,
                  value: isChecked24,
                  onChanged: (bool? value) {
                    setState(() {
          ...
          Card(
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title: const Text("INVENTARIO DEL VESTIDO"),
                  checkColor: Colors.white,
                  value: isChecked25,
                  onChanged: (bool? value) {
                    setState(() {
          ...
          Card(
            child: Column(
              children: [
                CheckboxListTile(
                  controlAffinity: ListTileControlAffinity.leading,
                  title: const Text("PLACA SERIE DEL VESTIDO"),
                  checkColor: Colors.white,
                  value: isChecked26,
                  onChanged: (bool? value) {
                    setState(() {
